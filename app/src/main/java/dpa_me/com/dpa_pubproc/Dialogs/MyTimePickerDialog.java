...
public class MyTimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PubProc.HandleViewAndFontSize.overrideFonts(getActivity().getApplicationContext(), view);
        return view;
    }
     ...
     * minutes, and the third will be either MyTimePickerDialog.AM or MyTimePickerDialog.PM.
     */
