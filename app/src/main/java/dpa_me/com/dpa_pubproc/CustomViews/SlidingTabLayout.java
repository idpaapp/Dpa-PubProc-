...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	protected TextView createDefaultTabView(Context context) {
        ...
        textView.setPadding(padding/2, PubProc.SlidingTabLayoutSize, padding/2, PubProc.SlidingTabLayoutSize);
        LinearLayout.LayoutParams param = ((LinearLayout.LayoutParams) textView.getLayoutParams());
        param.setMargins(1, 0, 0, 8);
        textView.setLayoutParams(param);
        textView.setBackgroundColor(getResources().getColor(R.color.divider_light));
        return textView;
    }
